...
export const BOSS_STRENGTH_MULTIPLIER = 10; // 10x player stats
...
export const DARK_SHOP_ITEMS: ShopItemDef[] = [
  { id: 'fire_3', name: 'Meteoro', description: 'Feitiço avançado de fogo (área média)', price: 1200, type: 'Spell', stat: 'Fire', value: 3 },
  { id: 'water_3', name: 'Gelo Eterno', description: 'Feitiço avançado de gelo (área média)', price: 1200, type: 'Spell', stat: 'Water', value: 3 },
  { id: 'earth_3', name: 'Terremoto', description: 'Feitiço avançado de terra (área média)', price: 1200, type: 'Spell', stat: 'Earth', value: 3 },
  { id: 'air_3', name: 'Tornado', description: 'Feitiço avançado de ar (área média)', price: 1200, type: 'Spell', stat: 'Air', value: 3 },
...
export const MAPS: Record<string, MapDefinition> = {
  ...
  NovaCidade: {
    ...
    portals: [
      ...
      { position: { x: 24, y: 2 }, size: { x: 2, y: 4 }, destination: 'TerrasCinzaEscuro', requiresQuest: 'quest_slay67' },
      { position: { x: 24, y: 22 }, size: { x: 3, y: 6 }, destination: 'TerrasForte', requiresQuest: 'quest_boss', variant: 'dragon' },
    ],
  },
};
